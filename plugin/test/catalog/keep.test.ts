...
const KEEP: Keep[] = [
  ...
  { id: "keep-11", title: "the Supervisor's askUserQuestionTimeout, amended by Q4", file: "harness/claude/settings/supervisor.settings.json", check: "none" },
  ...
  { id: "keep-13", title: "each seat gets its own team MCP server", file: "server/catalog/kit.ts", check: "contains", anchor: '[join(kit.dir, "mcp", "team.mjs"), role.role, role.tools, spool]' },

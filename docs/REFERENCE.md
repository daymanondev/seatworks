...
| `start_review` | Seats a read-only reviewing role. It runs where the change is now: the task's copy, the lane's copy, or the task branch. Its brief carries the question of every risk rule the change reaches |
